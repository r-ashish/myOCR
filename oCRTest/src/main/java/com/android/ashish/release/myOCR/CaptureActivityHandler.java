...
import com.android.ashish.release.myOCR.CaptureActivity;
import com.android.ashish.release.myOCR.R;
import com.android.ashish.release.myOCR.camera.CameraManager;
import com.android.ashish.release.myOCR.OcrResult;
  ...
  public void handleMessage(Message message) {
    ...
    switch (message.what) {
      ...
      case R.id.ocr_decode_failed:
        state = State.PREVIEW;
        activity.setShutterButtonClickable(true);
        Toast toast = Toast.makeText(activity.getBaseContext(), "It's sad but I didn't find any text. Would you mind trying again?", Toast.LENGTH_SHORT);
