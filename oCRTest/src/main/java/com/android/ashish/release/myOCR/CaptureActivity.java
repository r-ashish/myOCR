...
import com.android.ashish.release.myOCR.camera.CameraManager;
import com.android.ashish.release.myOCR.camera.ShutterButton;
...
public class CaptureActivity extends Activity implements SurfaceHolder.Callback,
  ...
  public static final String DEFAULT_TARGET_LANGUAGE_CODE = "hi";
  ...
  public static String sourceLanguageReadable; // Language name, for example, "English"
  ...
  public static String targetLanguageReadable; // Language name, for example, "English"
  ...
  private void displayFlashButton(){
      PackageManager pm= this.getPackageManager();
      if(isFlashSupported(pm)){
          ImageView flash_button = new ImageView(this);
          flash_button.setId(R.id.flash_button);
          flash_button.setImageResource(R.drawable.ic_action_flash_on);
          flash_button.setTop(0);
          flash_button.setLeft(0);
          flash_button.setPadding(15, 15, 0, 0);
          addContentView(flash_button, new ViewGroup.LayoutParams(90, 90));
          flash_button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
              try{camera = cameraManager.getCamera();
              final Camera.Parameters p = camera.getParameters();
              ImageView img = ((ImageView)findViewById(R.id.flash_button));
              if(isFlashOn){
                isFlashOn = true;
                p.setFlashMode(Camera.Parameters.FLASH_MODE_TORCH);
                img.setImageResource(R.drawable.ic_action_flash_off);
                ...
                img.setImageResource(R.drawable.ic_action_flash_on);
                camera.setParameters(p);
                camera.stopPreview();
              }}catch(Exception e){dialog.setMessage(e+" "+e.getMessage());dialog.show();}
            }
          });
      }
  }
  ...
  private void initOcrEngine(File storageRoot, String languageCode, String languageName) {    
    ...
    indeterminateDialog.setTitle("Hang on");
    ...
    if (ocrEngineModeName.equals("Both")) {
      ...
      indeterminateDialog.setMessage("Getting things ready for "+languageName+ " OCR....");
    }
 ...
 // public static final String source = "camera";
  boolean handleOcrDecode(OcrResult ocrResult) {
    lastResult = ocrResult;
    MainActivity.getOcrRes = ocrResult;
    ...
    toast.show();*/
    startActivity(intent);
    //textToSpeech.speak((CharSequence)(ocrResult.getText()), TextToSpeech.QUEUE_FLUSH, null,"OCRtext");
    return true;
  }
  ...
  public boolean onContextItemSelected(MenuItem item) {
    ...
    case OPTIONS_COPY_RECOGNIZED_TEXT_ID:
        String textToCopy = ocrResultView.getText().toString();
        clipboardManager.setText(textToCopy.subSequence(17, textToCopy.length()));
  ...
  void showLanguageName() {   
    Toast toast = Toast.makeText(this, "Ready to go!", Toast.LENGTH_SHORT);
    toast.setGravity(Gravity.TOP, 0, 0);
    toast.show();
  }
